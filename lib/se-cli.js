...
var stopSelenium = function() {
  getSeleniumProcessID(function(err, pid){
    if (err) {
      return console.log(clc.yellow('Nothing to stop.  Selenium is not running.  Run `se start` to start Selenium Server.\n'));
    }
...
module.exports = {
  startServer: startSelenium,
  stopServer: stopSelenium,
  isRunning: isSeleniumRunning,
  getProcessID: getSeleniumProcessID
};
